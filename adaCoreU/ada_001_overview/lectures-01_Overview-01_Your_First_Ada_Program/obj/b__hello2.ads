...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_hello2" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#b7793ca1#;
   pragma Export (C, u00001, "hello2B");
